...
const PRIORITY_BY_PATH = {
  ...
  '/touch-typing-fundamentals': { priority: '0.7', changefreq: 'monthly' },
  '/keyboard-layouts': { priority: '0.7', changefreq: 'monthly' },
  '/practice-routines': { priority: '0.7', changefreq: 'monthly' },
